"""
IHSAA (Idaho State Association) DataSource Adapter

Provides authoritative tournament brackets, seeds, scores, and championship results
for Idaho high school basketball.
...
- All regions of Idaho

**Idaho Basketball Context**:
- 150+ schools
- Strong basketball tradition
- IHSAA manages all high school athletics in Idaho
...
class IdahoIHSAADataSource(AssociationAdapterBase):
    """
    Idaho IHSAA adapter.
    ...
    **LIMITATIONS**:
    ...
    source_type = DataSourceType.IHSAA_ID
    source_name = "IHSAA"
    base_url = "https://www.idhsaa.org"
    region = DataSourceRegion.US_ID
    ...
    def __init__(self):
        """Initialize IHSAA datasource with Idaho-specific configuration."""
        super().__init__()
    ...
    def _build_bracket_url(
        ...
        **IHSAA URL Format**:
        ...
        # Try multiple URL patterns (IHSAA structure may vary)
    ...
    async def get_player(self, player_id: str) -> Optional[Player]:
        self.logger.warning("IHSAA does not provide player data - use MaxPreps for Idaho")
        return None
