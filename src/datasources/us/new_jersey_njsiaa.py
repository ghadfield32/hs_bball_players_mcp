"""
NJSIAA (New Jersey State Association) DataSource Adapter

Provides authoritative tournament brackets, seeds, scores, and championship results
for New Jersey high school basketball.

**Data Authority**: NJSIAA is the source of truth for:
- Tournament brackets (8 classifications: North Group 1, North Group 2, North Group 3, North Group 4, South Group 1, South Group 2, South Group 3, South Group 4)
- Seeds and matchups
- Game dates, times, locations
- Final scores and champions
- Historical tournament data

**Base URL**: https://www.njsiaa.org
...
**Coverage**:
- Classifications: North Group 1, North Group 2, North Group 3, North Group 4, South Group 1, South Group 2, South Group 3, South Group 4 (enrollment-based)
- 400+ member schools
- Boys and Girls tournaments
- All regions of New Jersey

**New Jersey Basketball Context**:
- 400+ schools
- Strong basketball tradition
- NJSIAA manages all high school athletics in New Jersey
- Enrollment-based classifications (North Group 1 highest, South Group 4 lowest)
...
**Recommended Use**: NJSIAA provides official tournament brackets.
...
class NewJerseyNJSIAADataSource(AssociationAdapterBase):
    """
    New Jersey NJSIAA adapter.
    ...
    **COVERAGE**: 400+ schools with basketball programs.
    ...
    1. Tournament brackets for all classifications (North Group 1, North Group 2, North Group 3, North Group 4, South Group 1, South Group 2, South Group 3, South Group 4)
    ...
    **ARCHITECTURE**:
    ...
    - Enumerates classifications: North Group 1, North Group 2, North Group 3, North Group 4, South Group 1, South Group 2, South Group 3, South Group 4
    - Generates unique game IDs: njsiaa_{year}_{class}_{home}@{away}
    ...
    **LIMITATIONS**:
    ...
    # NJSIAA specific constants
    CLASSIFICATIONS = ["North Group 1", "North Group 2", "North Group 3", "North Group 4", "South Group 1", "South Group 2", "South Group 3", "South Group 4"]
    GENDERS = ["Boys", "Girls"]
    ...
    def __init__(self):
        """Initialize NJSIAA datasource with New Jersey-specific configuration."""
        super().__init__()
    ...
    def _build_bracket_url(
        ...
        **NJSIAA URL Format**:
        ...
        /sports/basketball/boys/brackets/2025/north group 1/
        /sports/basketball/girls/brackets/2025/north group 1/
        ...
        Args:
            classification: Classification name (North Group 1, North Group 2, North Group 3, North Group 4, South Group 1, South Group 2, South Group 3, South Group 4)
        ...
        # Try multiple URL patterns (NJSIAA structure may vary)
    ...
    async def get_tournament_brackets(
        ...
        **ENUMERATION STRATEGY**:
        ...
        Args:
            ...
            classification: Specific classification (North Group 1, North Group 2, North Group 3, North Group 4, South Group 1, South Group 2, South Group 3, South Group 4), None for all
            gender: "Boys" or "Girls"
        ...
        self.logger.info(
            f"Fetching NJSIAA tournament brackets",
            year=year,
        ...
        self.logger.info(
            f"Fetched all NJSIAA tournament brackets",
            year=year,
    ...
    def _parse_bracket_html(
        ...
        NJSIAA bracket pages typically contain:
    ...
    def _create_game(
        ...
        team1_id = canonical_team_id("njsiaa", team1)
        team2_id = canonical_team_id("njsiaa", team2)

        return Game(
            game_id=f"njsiaa_{year}_{classification.lower()}_{team1_id.split('_', 1)[1]}_vs_{team2_id.split('_', 1)[1]}",
            ...
            league=f"NJSIAA {classification}",
            season=f"{year-1}-{str(year)[2:]}",
            gender=gender.lower(),
    ...
    async def _parse_html_data(self, html: str, season: str) -> Dict:
        year = self._extract_year(season)
        soup = parse_html(html)
        bracket_data = self._parse_bracket_html(soup, year, "North Group 1", "Boys", "")
        return {
    ...
    async def get_player(self, player_id: str) -> Optional[Player]:
        self.logger.warning("NJSIAA does not provide player data - use MaxPreps for New Jersey")
        return None
