"""
SDHSAA (South Dakota State Association) DataSource Adapter

Provides authoritative tournament brackets, seeds, scores, and championship results
for South Dakota high school basketball.

**Data Authority**: SDHSAA is the source of truth for:
- Tournament brackets (3 classifications: AA, A, B)
- Seeds and matchups
- Game dates, times, locations
- Final scores and champions
- Historical tournament data

**Base URL**: https://www.sdhsaa.com
...
**Coverage**:
- Classifications: AA, A, B (enrollment-based)
- 150+ member schools
- Boys and Girls tournaments
- All regions of South Dakota

**South Dakota Basketball Context**:
- 150+ schools
- Strong basketball tradition
- SDHSAA manages all high school athletics in South Dakota
- Enrollment-based classifications (AA highest, B lowest)
...
**Recommended Use**: SDHSAA provides official tournament brackets.
...
class SouthDakotaSDHSAADataSource(AssociationAdapterBase):
    """
    South Dakota SDHSAA adapter.
    ...
    **COVERAGE**: 150+ schools with basketball programs.
    ...
    1. Tournament brackets for all classifications (AA, A, B)
    ...
    **ARCHITECTURE**:
    ...
    - Enumerates classifications: AA, A, B
    - Generates unique game IDs: sdhsaa_{year}_{class}_{home}@{away}
    ...
    **LIMITATIONS**:
    ...
    source_type = DataSourceType.SDHSAA
    source_name = "SDHSAA"
    base_url = "https://www.sdhsaa.com"
    region = DataSourceRegion.US_SD

    # SDHSAA specific constants
    CLASSIFICATIONS = ["AA", "A", "B"]
    GENDERS = ["Boys", "Girls"]
    ...
    def __init__(self):
        """Initialize SDHSAA datasource with South Dakota-specific configuration."""
        super().__init__()
    ...
    def _build_bracket_url(
        ...
        **SDHSAA URL Format**:
        ...
        /sports/basketball/girls/brackets/2025/aa/
        ...
        Args:
            classification: Classification name (AA, A, B)
        ...
        # Try multiple URL patterns (SDHSAA structure may vary)
    ...
    async def get_tournament_brackets(
        ...
        **ENUMERATION STRATEGY**:
        ...
        Args:
            ...
            classification: Specific classification (AA, A, B), None for all
            gender: "Boys" or "Girls"
        ...
        self.logger.info(
            f"Fetching SDHSAA tournament brackets",
            year=year,
        ...
        self.logger.info(
            f"Fetched all SDHSAA tournament brackets",
            year=year,
    ...
    def _parse_bracket_html(
        ...
        SDHSAA bracket pages typically contain:
    ...
    def _create_game(
        ...
        team1_id = canonical_team_id("sdhsaa", team1)
        team2_id = canonical_team_id("sdhsaa", team2)

        return Game(
            game_id=f"sdhsaa_{year}_{classification.lower()}_{team1_id.split('_', 1)[1]}_vs_{team2_id.split('_', 1)[1]}",
            ...
            league=f"SDHSAA {classification}",
            season=f"{year-1}-{str(year)[2:]}",
            gender=gender.lower(),
    ...
    async def get_player(self, player_id: str) -> Optional[Player]:
        self.logger.warning("SDHSAA does not provide player data - use MaxPreps for South Dakota")
        return None
