"""
MSHSAA (Missouri State Association) DataSource Adapter

Provides authoritative tournament brackets, seeds, scores, and championship results
for Missouri high school basketball.

**Data Authority**: MSHSAA is the source of truth for:
- Tournament brackets (6 classifications: Class 6, Class 5, Class 4, Class 3, Class 2, Class 1)
- Seeds and matchups
- Game dates, times, locations
- Final scores and champions
- Historical tournament data

**Base URL**: https://www.mshsaa.org
...
**Coverage**:
- Classifications: Class 6, Class 5, Class 4, Class 3, Class 2, Class 1 (enrollment-based)
- 500+ member schools
- Boys and Girls tournaments
- All regions of Missouri

**Missouri Basketball Context**:
- 500+ schools
- Notable tradition (Bradley Beal,Jayson Tatum,Larry Drew)
- MSHSAA manages all high school athletics in Missouri
- Enrollment-based classifications (Class 6 highest, Class 1 lowest)
...
**Recommended Use**: MSHSAA provides official tournament brackets.
...
class MissouriMSHSAADataSource(AssociationAdapterBase):
    """
    Missouri MSHSAA adapter.

    **PRIMARY PURPOSE**: Authoritative tournament bracket and postseason results.

    **COVERAGE**: 500+ schools with basketball programs.

    This adapter provides:
    1. Tournament brackets for all classifications (Class 6, Class 5, Class 4, Class 3, Class 2, Class 1)
    ...
    **ARCHITECTURE**:
    ...
    - Enumerates classifications: Class 6, Class 5, Class 4, Class 3, Class 2, Class 1
    - Generates unique game IDs: mshsaa_{year}_{class}_{home}@{away}
    ...
    **LIMITATIONS**:
    ...
    # MSHSAA specific constants
    CLASSIFICATIONS = ["Class 6", "Class 5", "Class 4", "Class 3", "Class 2", "Class 1"]
    GENDERS = ["Boys", "Girls"]
    ...
    def __init__(self):
        """Initialize MSHSAA datasource with Missouri-specific configuration."""
        super().__init__()
    ...
    def _build_bracket_url(
        ...
        **MSHSAA URL Format**:
        ...
        /sports/basketball/boys/brackets/2025/class 6/
        /sports/basketball/girls/brackets/2025/class 6/
        ...
        Args:
            classification: Classification name (Class 6, Class 5, Class 4, Class 3, Class 2, Class 1)
        ...
        # Try multiple URL patterns (MSHSAA structure may vary)
    ...
    async def get_tournament_brackets(
        ...
        **ENUMERATION STRATEGY**:
        ...
        Args:
            ...
            classification: Specific classification (Class 6, Class 5, Class 4, Class 3, Class 2, Class 1), None for all
            gender: "Boys" or "Girls"
        ...
        self.logger.info(
            f"Fetching MSHSAA tournament brackets",
            year=year,
        ...
        self.logger.info(
            f"Fetched all MSHSAA tournament brackets",
            year=year,
    ...
    def _parse_bracket_html(
        ...
        MSHSAA bracket pages typically contain:
    ...
    def _create_game(
        ...
        team1_id = canonical_team_id("mshsaa", team1)
        team2_id = canonical_team_id("mshsaa", team2)

        return Game(
            game_id=f"mshsaa_{year}_{classification.lower()}_{team1_id.split('_', 1)[1]}_vs_{team2_id.split('_', 1)[1]}",
            ...
            league=f"MSHSAA {classification}",
            season=f"{year-1}-{str(year)[2:]}",
            gender=gender.lower(),
    ...
    async def _parse_html_data(self, html: str, season: str) -> Dict:
        year = self._extract_year(season)
        soup = parse_html(html)
        bracket_data = self._parse_bracket_html(soup, year, "Class 6", "Boys", "")
        return {
    ...
    async def get_player(self, player_id: str) -> Optional[Player]:
        self.logger.warning("MSHSAA does not provide player data - use MaxPreps for Missouri")
        return None
