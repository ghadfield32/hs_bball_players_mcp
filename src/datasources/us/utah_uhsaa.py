"""
UHSAA (Utah State Association) DataSource Adapter

Provides authoritative tournament brackets, seeds, scores, and championship results
for Utah high school basketball.

**Data Authority**: UHSAA is the source of truth for:
...
**Utah Basketball Context**:
- 150+ schools
- Strong basketball tradition
- UHSAA manages all high school athletics in Utah
...
**Recommended Use**: UHSAA provides official tournament brackets.
...
class UtahUHSAADataSource(AssociationAdapterBase):
    """
    Utah UHSAA adapter.
    ...
    **ARCHITECTURE**:
    ...
    - Generates unique game IDs: uhsaa_{year}_{class}_{home}@{away}
    ...
    **LIMITATIONS**:
    ...
    def __init__(self):
        """Initialize UHSAA datasource with Utah-specific configuration."""
        super().__init__()
    ...
    def _build_bracket_url(
        ...
        **UHSAA URL Format**:
        ...
        # Try multiple URL patterns (UHSAA structure may vary)
    ...
    async def get_tournament_brackets(
        ...
        **ENUMERATION STRATEGY**:
        ...
        self.logger.info(
            f"Fetching UHSAA tournament brackets",
            year=year,
        ...
        self.logger.info(
            f"Fetched all UHSAA tournament brackets",
            year=year,
    ...
    def _parse_bracket_html(
        ...
        UHSAA bracket pages typically contain:
    ...
    def _create_game(
        ...
        team1_id = canonical_team_id("uhsaa", team1)
        team2_id = canonical_team_id("uhsaa", team2)

        return Game(
            game_id=f"uhsaa_{year}_{classification.lower()}_{team1_id.split('_', 1)[1]}_vs_{team2_id.split('_', 1)[1]}",
    ...
    async def get_player(self, player_id: str) -> Optional[Player]:
        self.logger.warning("UHSAA does not provide player data - use MaxPreps for Utah")
        return None
