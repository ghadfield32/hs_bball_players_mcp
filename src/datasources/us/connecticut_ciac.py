"""
CIAC (Connecticut State Association) DataSource Adapter

Provides authoritative tournament brackets, seeds, scores, and championship results
for Connecticut high school basketball.

**Data Authority**: CIAC is the source of truth for:
- Tournament brackets (4 classifications: Division I, Division II, Division III, Division IV)
- Seeds and matchups
- Game dates, times, locations
- Final scores and champions
- Historical tournament data

**Base URL**: https://www.ciacsports.com
...
**Coverage**:
- Classifications: Division I, Division II, Division III, Division IV (enrollment-based)
- 150+ member schools
- Boys and Girls tournaments
- All regions of Connecticut

**Connecticut Basketball Context**:
- 150+ schools
- Strong basketball tradition
- CIAC manages all high school athletics in Connecticut
- Enrollment-based classifications (Division I highest, Division IV lowest)
...
**Recommended Use**: CIAC provides official tournament brackets.
...
class ConnecticutCIACDataSource(AssociationAdapterBase):
    """
    Connecticut CIAC adapter.

    **PRIMARY PURPOSE**: Authoritative tournament bracket and postseason results.

    **COVERAGE**: 150+ schools with basketball programs.

    This adapter provides:
    1. Tournament brackets for all classifications (Division I, Division II, Division III, Division IV)
    ...
    **ARCHITECTURE**:
    ...
    - Enumerates classifications: Division I, Division II, Division III, Division IV
    - Generates unique game IDs: ciac_{year}_{class}_{home}@{away}
    ...
    **LIMITATIONS**:
    ...
    # CIAC specific constants
    CLASSIFICATIONS = ["Division I", "Division II", "Division III", "Division IV"]
    GENDERS = ["Boys", "Girls"]
    ...
    def __init__(self):
        """Initialize CIAC datasource with Connecticut-specific configuration."""
        super().__init__()
    ...
    def _build_bracket_url(
        ...
        **CIAC URL Format**:
        ...
        /sports/basketball/girls/brackets/2025/division i/
        ...
        Args:
            classification: Classification name (Division I, Division II, Division III, Division IV)
        ...
        # Try multiple URL patterns (CIAC structure may vary)
    ...
    async def get_tournament_brackets(
        ...
        **ENUMERATION STRATEGY**:
        ...
        Args:
            ...
            classification: Specific classification (Division I, Division II, Division III, Division IV), None for all
            gender: "Boys" or "Girls"
        ...
        self.logger.info(
            f"Fetching CIAC tournament brackets",
            year=year,
        ...
        self.logger.info(
            f"Fetched all CIAC tournament brackets",
            year=year,
    ...
    def _parse_bracket_html(
        ...
        CIAC bracket pages typically contain:
    ...
    def _create_game(
        ...
        team1_id = canonical_team_id("ciac", team1)
        team2_id = canonical_team_id("ciac", team2)

        return Game(
            game_id=f"ciac_{year}_{classification.lower()}_{team1_id.split('_', 1)[1]}_vs_{team2_id.split('_', 1)[1]}",
    ...
    async def _parse_html_data(self, html: str, season: str) -> Dict:
        year = self._extract_year(season)
        soup = parse_html(html)
        bracket_data = self._parse_bracket_html(soup, year, "Division I", "Boys", "")
        return {
    ...
    async def get_player(self, player_id: str) -> Optional[Player]:
        self.logger.warning("CIAC does not provide player data - use MaxPreps for Connecticut")
        return None
